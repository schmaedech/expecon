...
public class ShareController extends AbstractShareView {
    ...
    public ShareController(Account controlledAccount, Share controlledShare, Time controlledTime) {
        ...
        StockData model = new StockData("resources/config/share.txt");
        
        sorter = new TableRowSorter<StockData>(model);
