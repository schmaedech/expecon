...
public class Account extends java.util.Observable {
    ...
    public Account( JTable accountTable ) {
        ...
        //notas do jocker-----        
        String ans;
        ans = JOptionPane.showInputDialog(null, "<html><br />Enter your username:<br /></html>","Start!",JOptionPane.INFORMATION_MESSAGE);
        if(ans == null){
           System.exit(0);
        }
        if(ans.equals("") ){
          String ansJocker = JOptionPane.showInputDialog(null, "<html>You did not enter a name!<br />" +
    ...
    public void saveAs(){
        ...
        try {
            pw = new PrintWriter(new FileWriter("resources"+System.getProperty("file.separator")+"outputTable.txt"));
        ...
        JOptionPane.showMessageDialog(accountTable, getAccountName() + ", The simulation ended! ");
        System.exit(0);
        /*
